...
const s = {
  ...
  submit: { background: C.primary, color: "#fff", border: "none", borderRadius: 10, padding: "10px 28px", fontSize: 14, fontWeight: 600, textDecoration: "none", minHeight: 40, cursor: "pointer", display: "inline-flex", alignItems: "center" },
  ...
  modelBadge: { fontSize: 10, fontWeight: 700, color: C.purple, background: "#f3ecff", padding: "2px 8px", borderRadius: 10 },
