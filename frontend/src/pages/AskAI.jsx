      ...
      {result && !loading && (
        <div style={s.answerCard}>
          ...
          <div style={s.helpfulRow}>
            ...
            <button style={{ ...s.thumb, color: helpful === "up" ? "#1a7f37" : C.muted }} onClick={() => setHelpful("up")}>
...
const s = {
  headerCard: { background: C.surface, border: `1px solid ${C.border}`, borderRadius: 4, padding: 16, marginBottom: 12 },
  h1: { fontSize: 20, fontWeight: 700, color: C.text, margin: 0 },
  sub: { fontSize: 14, color: C.muted, margin: "6px 0 0" },
  inputCard: { background: C.surface, border: `1px solid ${C.border}`, borderRadius: 4, padding: 16 },
  textarea: { width: "100%", minHeight: 200, border: `1px solid ${C.border}`, borderRadius: 4, padding: "12px 14px", fontSize: 16, lineHeight: 1.6, resize: "vertical", boxSizing: "border-box", fontFamily: "inherit", color: C.text },
  tagBox: { display: "flex", flexWrap: "wrap", gap: 6, alignItems: "center", border: `1px solid ${C.border}`, borderRadius: 4, padding: "8px 10px", minHeight: 44, boxSizing: "border-box", marginTop: 12 },
  ...
  error: { background: "#fff5f5", border: "1px solid #fed7d7", borderRadius: 6, padding: "10px 14px", margin: "12px 0 0", fontSize: 14, color: C.danger },
  btnRow: { display: "flex", justifyContent: "flex-end", marginTop: 12 },
  submit: { background: C.primary, color: "#fff", border: "none", borderRadius: 20, padding: "9px 28px", fontSize: 14, fontWeight: 700, textDecoration: "none", minHeight: 38, cursor: "pointer", display: "inline-flex", alignItems: "center", textTransform: "uppercase" },
  answerCard: { background: C.surface, border: `1px solid ${C.border}`, borderRadius: 4, padding: 16, marginTop: 12 },
  answerHead: { display: "flex", alignItems: "center", gap: 8, marginBottom: 10 },
  answerLabel: { fontSize: 14, fontWeight: 700, color: C.text },
  modelBadge: { fontSize: 10, fontWeight: 700, color: "#8250df", background: "#f3ecff", padding: "2px 8px", borderRadius: 10 },
  answerText: { fontSize: 15, color: C.text, lineHeight: 1.75, whiteSpace: "pre-wrap" },
  viewLink: { display: "inline-block", marginTop: 14, color: C.blue, fontWeight: 700, fontSize: 14, textDecoration: "none" },
  ...
  suggestGrid: { display: "flex", flexWrap: "wrap", gap: 12, marginTop: 12 },
  suggestCard: { flex: "1 1 200px", textAlign: "left", background: C.surface, border: `1px solid ${C.border}`, borderRadius: 4, padding: 14, fontSize: 14, color: C.text, cursor: "pointer", minWidth: 0 },
};
