...
const s = {
  page: { maxWidth: 1100, margin: "32px auto", padding: "0 20px" },
  ...
  sub: { color: "#7a8794", fontSize: 13, marginTop: 2 },
  pill: { background: "#e7f9f1", color: "#16c784", padding: "6px 16px", borderRadius: 20, fontSize: 13, fontWeight: 700 },
  grid4: { display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 16, marginBottom: 16 },
  grid2: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 },
  card: { background: "#fff", borderRadius: 14, padding: "20px", boxShadow: "0 2px 12px rgba(0,0,0,.06)" },
  metaLabel: { fontSize: 12, color: "#7a8794", fontWeight: 600, marginBottom: 8, textTransform: "uppercase", letterSpacing: ".5px" },
  metric: { fontSize: 28, fontWeight: 700, marginBottom: 4 },
  metaSub: { fontSize: 12, color: "#a0aec0", marginBottom: 8 },
  cardTitle: { fontSize: 14, fontWeight: 600, marginBottom: 12, color: "#1f2a37", display: "flex", alignItems: "center", gap: 8 },
  naTag: { fontSize: 11, fontWeight: 500, color: "#a0aec0", background: "#f7fafc", padding: "2px 8px", borderRadius: 6 },
  gaugeCenter: { position: "absolute", top: "55%", textAlign: "center", transform: "translateY(-50%)" },
  gaugeVal: { fontSize: 24, fontWeight: 700 },
  gaugeLabel: { fontSize: 11, color: "#7a8794" },
  empty: { color: "#a0aec0", fontSize: 14, textAlign: "center", paddingTop: 40 },
};
